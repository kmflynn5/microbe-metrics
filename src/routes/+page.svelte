...
<svelte:head>
	...
	<meta name="description" content="Real-time analytics dashboard for JGI bacterial and archaeal genome data pipeline" />
</svelte:head>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
	...
	<div class="mb-8">
		...
		<p class="text-lg text-gray-600 dark:text-gray-300">
			Real-time analysis of JGI bacterial and archaeal genome projects with advanced data pipeline monitoring
		</p>
	</div>
	...
	<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-700">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			<div class="text-center">
				...
				<p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Automated JGI data extraction and processing</p>
			</div>
			...
			<div class="text-center">
				...
				<p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Complex queries with DuckDB and predictive models</p>
			</div>
			...
			<div class="text-center">
				...
				<p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Interactive D3.js charts and research insights</p>
			</div>

			<div class="text-center">
				<div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center mx-auto mb-3">
					<svg class="w-6 h-6 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" d="M9.348 14.651a3.75 3.75 0 010-5.303m5.304 0a3.75 3.75 0 010 5.303m-7.425 2.122a6.75 6.75 0 010-9.546m9.546 0a6.75 6.75 0 010 9.546M5.106 18.894c3.808-3.808 10.98-3.808 14.788 0M12 12h.01" />
					</svg>
				</div>
				<h3 class="font-medium text-gray-900 dark:text-white">Quality Monitoring</h3>
				<p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Data quality assessment and anomaly detection</p>
			</div>
		</div>
	</div>
</div>
